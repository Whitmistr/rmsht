...
public class RcTiarasInfoUI extends GridPane implements Initializable {
    ...
    public RcTiarasInfoUI(RcTiaras bot) {
        this.bot = bot;

        FXMLLoader loader = new FXMLLoader();
        Future<InputStream> stream = bot.getPlatform().invokeLater(() -> Resources.getAsStream("ned/bots/osrs/skills/runecrafting/rcTiaras/ui/InfoUI.fxml"));
